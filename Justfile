...
export source_repository := env_var_or_default("SOURCE_REPOSITORY", image_name)
...
build $target_image=image_name $tag=default_tag $base_image="ghcr.io/ublue-os/bazzite:stable":
    #!/usr/bin/env bash
    ...
    if [[ -z "$(git status -s)" ]]; then
        ...
        LABELS+=("--label" "io.artifacthub.package.readme-url=https://raw.githubusercontent.com/{{ repo_organization }}/{{ source_repository }}/${GIT_SHA}/README.md")
        LABELS+=("--label" "org.opencontainers.image.documentation=https://raw.githubusercontent.com/{{ repo_organization }}/{{ source_repository }}/${GIT_SHA}/README.md")
        LABELS+=("--label" "org.opencontainers.image.source=https://github.com/{{ repo_organization }}/{{ source_repository }}/blob/${GIT_SHA}/Containerfile")
        LABELS+=("--label" "org.opencontainers.image.url=https://github.com/{{ repo_organization }}/{{ source_repository }}/tree/${GIT_SHA}")
